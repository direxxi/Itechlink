...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    results: [
      { metric: '99.7%', value: 'Network Uptime Achieved', description: 'Dual-ISP failover configuration eliminated the connectivity outages that were disrupting real-time tracking operations' },
      { metric: '0', value: 'Data Loss Incidents', description: 'Automated backup to Azure and local NAS with weekly restore testing created a robust, tested disaster recovery capability' },
      { metric: '6', value: 'Offices Unified', description: 'All six regional locations connected via secure site-to-site VPN with centralised IT management and monitoring' },
      { metric: '60%', value: 'IT Support Ticket Reduction', description: 'Proactive monitoring and standardised infrastructure significantly reduced the frequency and impact of IT issues' },
    ],
    testimonial: {
      quote: 'We were losing business because our IT simply couldn\'t keep up with our growth. iTechLink understood both our technical needs and our business context, and delivered an infrastructure that we can genuinely rely on. Our operations managers are no longer constantly firefighting IT problems.',
      author: 'Amaka Okonkwo',
      role: 'COO, SwiftLogistics Nigeria',
    },
    servicesTags: ['it-infrastructure-procurement', 'cybersecurity', 'managed-it-support', 'cloud-solutions'],
  },
  {
    ...
    results: [
      { metric: '220%', value: 'Increase in Organic Traffic', description: 'Organic search visits grew from 1,200 to 3,840 monthly visitors within 9 months of the SEO programme launch' },
      { metric: '3.4%', value: 'Checkout Conversion Rate', description: 'Rebuilt checkout and product page experience lifted conversions from 0.8% to 3.4% — a 4.25x improvement' },
      { metric: '#1', value: 'Rankings Achieved', description: 'AfroMarket achieved first-page Google rankings for 47 high-value target keywords within 6 months' },
      { metric: '68%', value: 'Reduction in Paid Spend', description: 'Growing organic traffic allowed AfroMarket to reduce paid advertising spend by 68% while maintaining revenue growth' },
    ],
    testimonial: {
      quote: 'We went from being invisible on Google to competing with much bigger players in our niche. The combination of the new website and the SEO strategy iTechLink developed has been genuinely transformational — our organic channel is now our primary acquisition source.',
      author: 'Tobi Adeleke',
      role: 'Founder & CEO, AfroMarket',
    },
    servicesTags: ['web-design-development', 'search-engine-optimisation', 'digital-marketing', 'ui-ux-design'],
  },
]
